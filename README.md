<div align="center">
  <img src="assets/logo.png" alt="GETOLS Logo" width="350">
</div>
...
| 🔐 **Secure Credentials** | AES-256-GCM encrypted, single CLI credential |
| 🔍 **ONU Discovery** | Deteksi ONU yang belum terdaftar via Telnet CLI |
...
| 🔧 **Custom Port** | Support port forwarding untuk Telnet |
...
GETOLS membutuhkan paket SNMP tools untuk monitoring:
...
│   │   └── zte/           # ZTE C300 & C320 adapters (Telnet)
│   ├── api/               # FastAPI routes
...
| Vendor | Model | Status | Connection |
|--------|-------|--------|------------|
| ZTE | ZXA10 C300 | ✅ Supported | Telnet |
| ZTE | ZXA10 C320 | ✅ Supported | Telnet |
...
4. Fill in:
   ...
   - SNMP RO Community (required)
   - SNMP RW Community (optional, for maintenance)
