...
### Changed
- CLI Access: ZTE OLT now uses Telnet only
- SNMP v2c: Separated into RO and RW communities
- Logo Display: Increased sizes for better branding

### Added
- SNMP Setup Scripts helper on Add OLT page
- SNMP RW community field (Admin only, logged)
- Reset password instructions on login page
- Header logo display

### Fixed
- SQLAlchemy session handling
- Template null-safety checks
...
### Security Notes
- SNMP RW operations logged and Admin only
